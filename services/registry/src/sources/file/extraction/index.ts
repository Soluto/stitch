...
const extractors: { [kind: string]: (mimeType: string, content: string) => GqlAgogosObjectConfig } = {
...
export default async (kind: string, file: string): Promise<GqlAgogosObjectConfig> => {
